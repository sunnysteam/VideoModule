...
public class MediaSessionManager {
    ...
    public void updateMetaData(MusicModel music) {
        if (music == null) {
        ...
        MediaMetadataCompat.Builder metaData = new MediaMetadataCompat.Builder()
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, music.getMusic_artist())
                .putString(MediaMetadataCompat.METADATA_KEY_ALBUM, music.getMusic_album())
                .putString(MediaMetadataCompat.METADATA_KEY_ALBUM_ARTIST, music.getMusic_artist())
                .putLong(MediaMetadataCompat.METADATA_KEY_DURATION, music.getMusic_duration())
                .putBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART, BitmapFactory.decodeFile(music.getMusic_album_cover_path()));

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            metaData.putLong(MediaMetadataCompat.METADATA_KEY_NUM_TRACKS, mPlayService.mMusicList.size());
        }
